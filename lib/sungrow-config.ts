...
export const NEXT_PUBLIC_SUNGROW_AUTHORIZE_URL = process.env.NEXT_PUBLIC_SUNGROW_AUTHORIZE_URL || '';
console.log('NEXT_PUBLIC_SUNGROW_AUTHORIZE_URL:', NEXT_PUBLIC_SUNGROW_AUTHORIZE_URL);

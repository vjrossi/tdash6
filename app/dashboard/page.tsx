...
export default function UnifiedDashboard() {
    ...
    const handleGlobalLogout = async () => {
        // Attempt to clear both sessions
        // Note: In a real scenario you might want to wait for both, 
        // but Next.js redirects in server actions can conflict. 
        // We will call the actions but handle the redirect client-side.
        await teslaLogout(); // This sets cookies to expire
        await sungrowLogout(); // This sets cookies to expire
        router.push('/');
    };
